...
모험가는 모험을 통해 다양한 아이템을 획득할 수 있습니다. 하지만 코인은 거래를 통해서만 획득이 가능하기 때문에, 모험을 통해 성장하고 더 강한 괴물과의 전투를 통해 좋은 아이템을 획득해야 시장에서 많은 코인을 받을 수 있습니다. 이 모험가의 생활 주기는 [던전 월드]의 룰을 채택하여 다양한 상황에서도 랜덤 요소를 활용한 일관된 보상 체계를 가질 수 있도록 의도하였습니다.
