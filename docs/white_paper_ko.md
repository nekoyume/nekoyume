...
## 2.<!-- pseudo-random-number-generation-prng --> 유사 랜덤 생성 (PRNG)
...
### 2.1.<!-- random-generation-using-block-values --> 블록 값를 활용한 랜덤 생성
...
### 2.2.<!-- random-generation-using-external-services --> 외부 서비스를 활용한 랜덤 생성
...
### 3.1.<!-- combination-of-behavior-information-from-hash-value-and-block-hash --> 행동 정보 해시와 블록 해시의 조합
...
### 3.2.<!-- behavior-information-that-can-be-included-in-a-block-time-limit --> 블록에 포함할 수 있는 행동 정보 시간 제한
...
## 4.<!-- decentralized-mmorpg --> 탈중앙화된 MMORPG
...
#### 5.2.1.<!-- block-generation-consensus --> 블록 생성 컨센서스
...
#### 5.2.2.<!-- compensation-system --> 보상 체계
...
#### 5.3.1.<!-- benefit-of-gold --> 골드 사용의 이점
...
#### 5.3.2.<!-- the-way-to-earn-gold --> 골드의 획득 방법

#### 5.3.2.1.<!-- gold-generation-event --> 골드 발행 이벤트
...
### 6.1.<!-- limitation-of-hash-random --> 해시 랜덤의 한계
